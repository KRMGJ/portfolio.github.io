                        ...
                        <CardContent className="p-6 space-y-4">
                            <div className="flex items-start justify-between gap-4">
                                <div>
                                    ...
                                    <div className="mt-2 flex flex-wrap gap-2">{p.tags.map((t) => <Badge key={t} variant="outline">{t}</Badge>)}</div>
                                </div>
                            </div>
                            ...
                            <div className="flex gap-3 flex-wrap">
                                {p.links.map((l) => (
                                    <Button key={l.href} variant="secondary" size="sm" asChild>
                                        <a href={l.href} target="_blank" rel="noreferrer" className="inline-flex items-center gap-1">{l.label} <ExternalLink className="h-3.5 w-3.5" /></a>
                                    </Button>
                                ))}
                            </div>
                        </CardContent>
